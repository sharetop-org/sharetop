"""Custom exceptions for the ShareTop SDK."""
...
class ShareTopError(Exception):
    """Base exception for all ShareTop SDK errors."""
...
class APIError(ShareTopError):
    """Error returned by the ShareTop API.
...
class ConnectionError(ShareTopError):
    """Network connection error."""

    pass


class TimeoutError(ShareTopError):
    """Request timeout."""
