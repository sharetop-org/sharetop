"""Local instrument name cache for ShareTop.

Caches symbol -> name mappings to avoid frequent API calls.
Cache directory is configurable via SHARETOP_CACHE_DIR environment variable.
"""
...
logger = logging.getLogger("sharetop.cache")

DEFAULT_CACHE_DIR = os.path.join(Path.home(), ".sharetop", "cache")
...
def _get_cache_dir() -> str:
    return os.environ.get("SHARETOP_CACHE_DIR", DEFAULT_CACHE_DIR)
